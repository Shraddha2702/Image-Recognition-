...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = getApplicationContext().getSharedPreferences("blindknow", Context.MODE_PRIVATE);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    Intent i = new Intent(SettingActivity.this, Splashscreen.class);
        ...
        btnRemoveUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressBar.setVisibility(View.VISIBLE);
                Toast.makeText(SettingActivity.this,"Your application may get redirected to Home Page !!!",Toast.LENGTH_LONG).show();
                if (user != null) {
                    user.delete()
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
